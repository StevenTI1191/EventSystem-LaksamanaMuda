            ...
            <div className="p-6">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                    ...
                    <div className="flex justify-end gap-4 mt-12">
                        ...
                        <button type="submit" disabled={processing} className="px-12 py-3 bg-[#A9791F] text-white rounded-full font-bold shadow-lg shadow-red-200 hover:bg-red-600 transition-all">
