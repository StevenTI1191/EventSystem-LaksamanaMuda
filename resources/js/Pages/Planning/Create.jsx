            ...
            <form onSubmit={submit} className="max-w-3xl bg-white p-8 sm:p-10 rounded-[2rem] shadow-sm border border-gray-100">
                ...
                <div className="space-y-5">
                    <div>
                        ...
                        <input type="text" placeholder="Silahkan Input Nama Event"
                            className="w-full p-3 border-gray-200 rounded-xl bg-gray-50 focus:border-[#A9791F] focus:ring-1 focus:ring-[#A9791F] focus:outline-none"
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <select className="w-full p-3 border-gray-200 rounded-xl bg-gray-50 focus:border-[#A9791F] focus:ring-1 focus:ring-[#A9791F] focus:outline-none"
                        ...
                        <div>
                            ...
                            <input type="date" className="w-full p-3 border-gray-200 rounded-xl bg-gray-50 focus:border-[#A9791F] focus:ring-1 focus:ring-[#A9791F] focus:outline-none"
                    ...
                    <div>
                        ...
                        <textarea placeholder="Silahkan Input Deskripsi Event"
                            className="w-full h-24 p-3 border-gray-200 rounded-xl bg-gray-50 focus:border-[#A9791F] focus:ring-1 focus:ring-[#A9791F] focus:outline-none"
                            ...
                            {categories.map((c) => {
                                ...
                                return (
                                    <button type="button" key={c.name} onClick={() => toggleCat(c.name)}
                                        className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border text-left transition-all ${on ? 'border-[#A9791F] bg-pink-50/60' : 'border-gray-200 hover:border-gray-300'}`}>
                                        <span className={`w-5 h-5 rounded-md flex items-center justify-center shrink-0 border-2 ${on ? 'bg-[#A9791F] border-[#A9791F] text-white' : 'border-gray-300'}`}>
                ...
                <div className="flex justify-end gap-4 mt-10">
                    ...
                    <button type="submit" disabled={processing}
                        className="px-10 py-3 bg-[#A9791F] text-white rounded-full font-bold shadow-lg shadow-red-200 hover:bg-[#7A560F] transition-all disabled:opacity-60">
